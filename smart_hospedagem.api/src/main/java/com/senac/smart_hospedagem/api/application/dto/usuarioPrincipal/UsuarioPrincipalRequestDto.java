...
public record UsuarioPrincipalRequestDto(Long id, String email, String senha, String role, Usuario usuario, Pousada pousada, int tipo_cadastro, boolean cadastro_concluido) {
}
